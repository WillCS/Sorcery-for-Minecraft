...
public class NetherGenAbandonedNetherPortal4 extends WorldGenerator {
	...
	public NetherGenAbandonedNetherPortal4() {
	}
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 4, j + 1, k + 1, Blocks.nether_brick, 0, 2);
		...
		world.setBlock(i + 5, j + 0, k + 1, Blocks.nether_brick, 0, 2);
		...
		world.setBlock(i + 5, j + 1, k + 1, Blocks.nether_brick, 0, 2);
		world.setBlock(i + 5, j + 1, k + 2, Blocks.obsidian, 0, 2);
		world.setBlock(i + 5, j + 1, k + 3, Blocks.nether_brick, 0, 2);
		...
		world.setBlock(i + 5, j + 2, k + 2, Blocks.obsidian, 0, 2);
		...
		world.setBlock(i + 5, j + 3, k + 2, Blocks.obsidian, 0, 2);
		...
		world.setBlock(i + 5, j + 4, k + 2, Blocks.obsidian, 0, 2);
		...
		world.setBlock(i + 6, j + 0, k + 1, Blocks.nether_brick, 0, 2);
		world.setBlock(i + 6, j + 0, k + 2, Blocks.nether_brick, 0, 2);
		...
		world.setBlock(i + 6, j + 1, k + 1, Blocks.nether_brick, 0, 2);
		world.setBlock(i + 6, j + 1, k + 2, Blocks.nether_brick, 0, 2);
