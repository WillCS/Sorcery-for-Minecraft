...
public class NetherGenAbandonedNetherPortal3 extends WorldGenerator {
	...
	public NetherGenAbandonedNetherPortal3() {
	}
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 2, j + 4, k + 5, Blocks.obsidian, 0, 2);
		...
		world.setBlock(i + 2, j + 5, k + 4, Blocks.obsidian, 0, 2);
