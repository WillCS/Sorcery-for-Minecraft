...
public class RenderBlazeArrow extends Render {
	private static final ResourceLocation texture = Utils.getResource(Properties.TEXTURE_FOLDER + "entities/blazearrow.png");
	
	public void renderArrow(EntityBlazeArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9) {
	...
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		this.renderArrow((EntityBlazeArrow)par1Entity, par2, par4, par6, par8, par9);
	}
